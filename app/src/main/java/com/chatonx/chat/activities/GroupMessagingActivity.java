...
import com.chatonx.chat.adapters.MessagingAdapter;
import com.chatonx.chat.adapters.MessagingUsersAdapter;
        ...
        switch (v.getId()) {
            ...
            case R.id.option:
                ...
                popup.getMenuInflater()
                        .inflate(R.menu.group_messaging_menu, popup.getMenu());
                popup.setOnMenuItemClickListener(item -> {
                    switch (item.getItemId()) {
                        case R.id.contact:
                            mIntent = new Intent(GroupMessagingActivity.this, UserProfileActivity.class);
                            startActivity(mIntent);
                            break;
                        case R.id.more:
                            PopupMenu popup1 = new PopupMenu(GroupMessagingActivity.this, v);
